...
console.log("test");
o&&o({moduleName:Q,sessionId:p,subSystem:R,evtGroup:X,millis:(new Date).getTime(),type:Bb});a.contentWindow.location.replace(t+L)}}
...
if(n.addEventListener){
    n.addEventListener(Yb,function(){J();O()},false)
}
console.log("test2");
var N=setInterval(function(){if(/loaded|complete/.test(n.readyState)){J();O()}},50);
console.log("test2");
